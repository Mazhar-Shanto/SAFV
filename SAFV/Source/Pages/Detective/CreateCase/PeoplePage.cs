...
using SAFV.Source.Components.Detective.CreateCase.People;
using SAFV.Source.Components.Detective.CreateCase.People.Suspect;
...
namespace SAFV.Source.Pages.Detective.CreateCase
{
    public class PeoplePage : IncidentsPage
    {
        ...
        public void GoToPeoplePage()
        {
            ...
            Click(CaseMenuComponent.People);
        }
