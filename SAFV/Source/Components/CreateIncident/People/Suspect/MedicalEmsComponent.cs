...
namespace SAFV.Source.Components.CreateIncident.People.Suspect
{
    public class MedicalEmsComponent : BaseComponent
    {
        ...
        public static IWebElement MedicalTreatmentOfferedButRefused => WaitAndFindElement(By.XPath("//*[@id=\"ems-info-form\"]/div[1]/div[4]/div/span[1]"));
        public static IWebElement PersonSeekingTheirOwnTreatment => WaitAndFindElement(By.XPath("//*[@id=\"ems-info-form\"]/div[1]/div[5]/div/span[1]"));
        public static IWebElement DrWhoWillProvideTreatment => WaitAndFindElement(By.Id("TreatmentDrName"));
        public static IWebElement FirstAidGivenAtScene => WaitAndFindElement(By.XPath("//*[@id=\"ems-info-form\"]/div[1]/div[6]/div/span[1]"));
        public static IWebElement FirstAidGivenBy => WaitAndFindElement(By.Id("FirstAidGivenBy"));
        public static IWebElement EmsParamedicsFire => WaitAndFindElement(By.XPath("//*[@id=\"ems-info-form\"]/div[1]/div[7]/div/span[1]"));
        public static IWebElement EmsUnit => WaitAndFindElement(By.XPath("EMSUnit"));
        public static IWebElement EmsUnitTransportedPersonToHospital => WaitAndFindElement(By.XPath("//*[@id=\"ems-info-form\"]/div[1]/div[8]/div/span[1]"));
