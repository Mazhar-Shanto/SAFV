...
namespace SAFV.Source.Components
{
    public class IncidentMenuComponent : BaseComponent
    {
        ...
        public static IWebElement Relationships => WaitAndFindElement(By.XPath("//*[@id=\"remove-scroll\"]/div/ul/li[5]/ul/li[9]/a"));
        public static IWebElement Evidence => WaitAndFindElement(By.XPath("//*[@id=\"remove-scroll\"]/div/ul/li[5]/ul/li[10]/a"));
        public static IWebElement DigitalEvidence => WaitAndFindElement(By.XPath("//*[@id=\"remove-scroll\"]/div/ul/li[5]/ul/li[11]/a"));
        public static IWebElement Reports => WaitAndFindElement(By.XPath("//*[@id=\"remove-scroll\"]/div/ul/li[5]/ul/li[12]/a"));
        public static IWebElement IncidentReview => WaitAndFindElement(By.XPath("//*[@id=\"remove-scroll\"]/div/ul/li[5]/ul/li[12]/a"));
        public static IWebElement StatusHistory => WaitAndFindElement(By.XPath("//*[@id=\"remove-scroll\"]/div/ul/li[5]/ul/li[14]/a"));
