...
{
    public class QuickBookEvidenceComponent : BaseComponent
    {
        // Elements
        public static IWebElement AddEvidence => WaitAndFindElement(By.XPath("//*[@id=\"module-container\"]/div/div[1]/div/div[1]/button"));
        ...
        public static IWebElement Save => WaitAndFindElement(By.XPath("//*[@id=\"createincidentevidenceform\"]/div/div[9]/div/button[1]"));
        public static IWebElement Cancel => WaitAndFindElement(By.XPath("//*[@id=\"createincidentevidenceform\"]/div/div[9]/div/button[2]"));
        public static IWebElement Next => WaitAndFindElement(By.XPath("//*[@id=\"module-container\"]/div/div[1]/div/div[2]/button[2]"));
        public static IWebElement Back => WaitAndFindElement(By.XPath("//*[@id=\"module-container\"]/div/div[1]/div/div[2]/button[1]"));

        public QuickBookEvidenceComponent(IWebDriver driver) : base(driver)
        {
        }
    }
}
