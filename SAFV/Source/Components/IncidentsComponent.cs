...
namespace SAFV.Source.Components
{
    internal class IncidentsComponent : HeaderComponent
    {
        ...
        public static IWebElement LockedCaseNumberFilter => WaitAndFindElement(By.XPath("//*[@id=\"incident_grid_locked\"]/div[1]/div/table/thead/tr/th[3]/a/span"));
        ...
        public static IWebElement ShowOtherOfficerIncidentsButton => WaitAndFindElement(By.XPath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div[2]/div[1]/div/div[1]/span/span"));
        public static IWebElement ShowOtherOfficerLockedIncidentsButton => WaitAndFindElement(By.XPath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div[2]/div[2]/div/div[1]/span/span"));
