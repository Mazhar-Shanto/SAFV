...
{
    public class CaseInfoComponent : BaseComponent
    {
        // Elements
        ...
        public static IWebElement CpsNotifedDate => WaitAndFindElement(By.Id("CPSNotifedAt"));
        ...
        public static IList<IWebElement> LstHowPoliceContacted => WaitAndFindElements(By.XPath("//*[@id=\"ReasonForContactId_listbox\"]/li"));
        ...
        public CaseInfoComponent(IWebDriver driver) : base(driver)
        {
        }
    }
}
